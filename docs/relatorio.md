...
Os gráficos abaixo mostram a distribuição de idade dos repositórios e a relação entre idade e número de estrelas. O grupo suspeito de star-farming aparece destacado no gráfico de dispersão.

![Visualizações RQ01 e RQ02](visualizacoes/img-rq01-rq02.png)
...
Os gráficos abaixo ilustram a distribuição de releases e de dias desde o último push, evidenciando a forte assimetria à direita em ambas as métricas e a concentração da amostra em valores baixos de atualização.

![Visualizações RQ03 e RQ04](visualizacoes/img-rq03-rq04.png)
...
Os gráficos abaixo apresentam a distribuição de linguagens primárias na amostra, a razão de issues fechadas por repositório e as medianas das métricas de contribuição, releases e atualização agrupadas por linguagem.

![Visualizações RQ05, RQ06 e RQ07](visualizacoes/img-rq05-rq06-rq07.png)
...
A matriz abaixo exibe a correlação de Spearman entre todas as métricas numéricas coletadas. Pares com maior correlação absoluta aparecem em tons mais escuros, facilitando a identificação das relações discutidas nesta seção.

![Matriz de correlação global](visualizacoes/img-correlacao.png)
