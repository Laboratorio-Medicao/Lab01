...
**Atualização:** `releases_count` (RQ03) e `pushed_at` (RQ04) agora têm
validação cruzada própria em [`docs/validacao-rq03-rq04.md`](./validacao-rq03-rq04.md).
Com isso, a base usada por RQ07 ficou alinhada ao mesmo padrão de conferência
aplicado às demais métricas.
